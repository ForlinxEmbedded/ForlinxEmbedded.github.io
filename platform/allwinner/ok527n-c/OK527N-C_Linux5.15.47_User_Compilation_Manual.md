# Linux5.15.147\_User’s Compilation Manual_V1.1
...
|03/03/2026	|V1.1| Revised Section 4.2.1 "Full Compilation" Description |
...
### <font style="color:black;">4.2</font><font style="color:black;">  </font>Source Code Compilation

#### 4.2.1 Full Compilation  
Full compilation refers to the unified compilation of source code, including the kernel source code, library files, applications, and filesystem packaging.

First, select the configuration:

```bash
forlinx@ubuntu:~$ cd /home/forlinx/work/OKT527-linux-sdk                    # Enter the source code directory
forlinx@ubuntu:~/work/OKT527-linux-sdk$ ./build.sh config                    # Execute the configuration command
...
After the source code compilation is complete, an image needs to be generated by packaging the compiled files and configuration files.
