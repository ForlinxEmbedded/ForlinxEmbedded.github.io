...
| ---------- | :----------------------------------------------------------: | :----------------------------------------------------------: | :-------------------: | ------------------------------------------------------------ |
| 17/12/2025 | <font style="color:rgb(0,0,0);">V1.</font><font style="color:rgb(0,0,0);">5</font> | <font style="color:rgb(51,51,51);">V1.</font><font style="color:rgb(51,51,51);">1</font> |    V1.1 and above     | Adding SoM power management upgrade solution:<br />Expanding the voltage input range from 12V to<br />a wide voltage 5V-13V, and updating the voltage<br />input parameters of the SoM in the section “2. FET3588 - C SoM Description". |
| 21/11/2025 |                             V1.4                             |                             V1.1                             |    V1.1 and above     | Adding section 2.6.2: Design Guide for<br /> Vibration Resistance of the SoM |
